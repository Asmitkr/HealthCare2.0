...
const Signup_dr = () => {
  return (
    <div><div><div className='py-20 px-20 flex justify-center w-full h-screen bg-zinc-900'>
    ...
    <div className='absolute right-12'>
        ...
        <input className="placeholder:text-zinc-500 bg-transparent w-72 mb-3 outline-none rounded" type="Number" placeholder='Type' />
